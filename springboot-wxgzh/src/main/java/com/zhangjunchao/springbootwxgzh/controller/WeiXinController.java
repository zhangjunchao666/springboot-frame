...
import com.zhangjunchao.springbootwxgzh.bean.*;
import com.zhangjunchao.springbootwxgzh.common.*;
import com.zhangjunchao.springbootwxgzh.weixinmsg.MsgUtil;
...
public class WeiXinController {
    ...
    @ResponseBody
    @PostMapping("/wget")
    public void getWeiXinInfo(HttpServletRequest request, HttpServletResponse response) throws IOException {
